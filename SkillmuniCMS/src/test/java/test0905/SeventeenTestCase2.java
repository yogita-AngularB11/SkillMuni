package test0905;
//------------------------------------Finally Worked well For Skill Knook-----------------------------------
...
public class SeventeenTestCase2 {
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("//a[@href='/Skillmuni_Prod/skill-zone']")).click();
...
//								.findElements(By.xpath(".//iframe[contains(@src,'youtube.com/embed/')]")).isEmpty();
						boolean hasIframeVideo = !brief.findElements(
