            ...
            for (String[] zone : zones) {
                ...
                try {
                    ...
                    for (int i = 0; i < categories.size(); i++) {
                        categories = driver.findElements(By.xpath("//div[contains(@class,'play-card-content')]")); // refresh list
                        ...
                        try {
                            ...
                            try {
                                ...
                                driver.navigate().back();  // to return to question page
                                Thread.sleep(2000);
                            }
                         ...
                         // After clicking "Continue", wait for loader to disappear
                            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".loader-overlay")));

                            try {
                                // Re-locate fresh instance of the back button
...
//                                // Again click back button to return to category list (if needed)
//                                WebElement backToCategoryBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@alt='Back Icon']")));
